        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    ...
                    <a href="javascript:;"  class="py-2.5 px-5 h-9 block w-fit bg-[#003B5C] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 lg:mx-0">
                        Contact us
                    </a>
                </div>
                <!--End Col-->
                <div class="lg:mx-auto text-left ">
                    <h4 class="text-lg text-gray-900 font-medium mb-7">Wilco</h4>
                ...
                <div class="lg:mx-auto text-left ">
                    ...
                    <a href="javascript:;"  class="flex items-center justify-center gap-2 bg-[#003B5C] rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-neutral-50 font-semibold transition-all duration-500">Subscribe<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.25 6L13.25 6M9.5 10.5L13.4697 6.53033C13.7197 6.28033 13.8447 6.15533 13.8447 6C13.8447 5.84467 13.7197 5.71967 13.4697 5.46967L9.5 1.5" stroke="#ffffff" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        </a>
                </div>
            </div>
